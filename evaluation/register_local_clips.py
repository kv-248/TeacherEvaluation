...
def main() -> None:
    ...
    clips_root = ensure_dir(args.clips_root)
    ...
    for index, source_path in enumerate(clips, start=1):
        ...
        _register_clip(source_path, target_path, copy_mode=args.copy)
        metadata = {
            ...
            "registration_mode": "copy" if args.copy else "symlink",
        }
